                        ...
                        <div class="card-body">
                            <form method="post" action="./procesos/insertarCrud.php" >
                                <div class="form-floating">
                                    ...
                                    <label for="floatingSelectGrid"><i class="fa-solid fa-car me-2"></i>Marca</label>
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="txtColor" id="inlineRadio1" value="Rojo">
                                        <label class="form-check-label" for="inlineRadio1">Rojo</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="txtColor" id="inlineRadio2" value="Azul">
                                        <label class="form-check-label" for="inlineRadio2">Azul</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="txtColor" id="inlineRadio3" value="Negro">
